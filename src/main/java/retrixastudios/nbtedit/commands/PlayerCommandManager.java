...
import retrixastudios.nbtedit.commands.playersub.PlayerCheck;
import retrixastudios.nbtedit.commands.playersub.PlayerSet;
import retrixastudios.nbtedit.commands.playersub.PlayerView;
...
public class PlayerCommandManager implements CommandExecutor, TabCompleter {
    ...
    public PlayerCommandManager() {
        ...
        commands.add(new PlayerView());
        commands.add(new PlayerSet());
        commands.add(new PlayerCheck());
    }
